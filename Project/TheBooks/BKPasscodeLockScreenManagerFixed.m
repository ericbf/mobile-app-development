//
//  BKPasscodeLockScreenManagerFixed.m
//  BKPasscodeViewDemo
//
...
#import "BKPasscodeLockScreenManagerFixed.h"

static BKPasscodeLockScreenManagerFixed *_sharedManager;

@interface BKPasscodeLockScreenManagerFixed ()
...
@implementation BKPasscodeLockScreenManagerFixed

+ (BKPasscodeLockScreenManagerFixed *)sharedManager
{
	static dispatch_once_t onceToken;
	dispatch_once(&onceToken, ^{
		_sharedManager = [[BKPasscodeLockScreenManagerFixed alloc] init];
	});
...
- (void)showLockScreen:(BOOL)animated
{
	...
	// Change this to blindView, because there is a bug in the library's implementation.
	if (nil == blindView) {
