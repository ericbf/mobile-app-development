...
func associated<Type>(with: AnyObject, key: UnsafePointer<UInt8>, initial: () -> Type) -> Type {
	...
	associate(with: with, key: key, value: initialValue)
	
	return initialValue
}

func associate<Type>(with: AnyObject, key: UnsafePointer<UInt8>, value: Type) {
